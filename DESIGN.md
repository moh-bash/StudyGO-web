...
Duolingo's interface treats the page like a children's storybook: white paper canvas, chubby rounded display type, and a single saturated blue that reads as 'correct answer' the moment it appears. Body copy stays calm in mid-gray so the blue and its accent blue can do all the emotional work — blue for progress and headings, blue for interactive links and secondary actions. Components are pill-shaped or chunky-rounded with thick 2px borders in black or color, giving every button the feel of a sticker pressed onto the page rather than a flat UI control.

## Tokens — Colors

| Name | Value | Token | Role |
|------|-------|-------|------|
| Eager Blue | `#58cc02` | `--color-eager-blue` | Blue text accent for links, tags, and emphasized short phrases. Do not promote it to the primary CTA color |
| Storybook Blue | `#d7ffb8` | `--color-storybook-blue` | Soft highlight wash on light surfaces, subtle background tints behind footer navigation labels |
...
| Fresh Leaf | `#a5ed6e` | `--color-fresh-leaf` | Blue text accent for links, tags, and emphasized short phrases. Do not promote it to the primary CTA color |
| Night Ink | `#000437` | `--color-night-ink` | Violet text accent for links, tags, and emphasized short phrases. |
| Paper White | `#ffffff` | `--color-paper-white` | Page canvas, card surfaces, button text on blue/dark fills |
...
### Primary CTA Button
**Role:** Filled blue button for 'Get started' and top-of-page conversion

Fill #02a4cc, white text, duolingo-sans 700 at 15px uppercase with 0.0530em tracking, 12px border-radius, 16px horizontal padding. No border — color alone carries the button. Sits directly on white canvas.

### Outlined Account Button
**Role:** Secondary CTA below primary on hero

Transparent fill, text in #1cb0f6, duolingo-sans 700 at 14px, 12px border-radius, 16px horizontal padding, 2px solid border in #afafaf. Pairs with the blue CTA as a calm ghost alternative.
...
feather 700 at 48-64px, line-height 1.2, letter-spacing -0.0200em, color #02a4cc. The signature voice of the brand — large, rounded, unmistakably blue.

### Hero Headline
**Role:** Opening page headline above CTA

duolingo-sans 700 at 32px, color #4b4b4b (Charcoal). Stays neutral so the blue CTA below it carries the color weight.
...
### Footer Background
**Role:** Full-width blue band at bottom

#02a4cc fill, white and #d7ffb8 text labels, generous 48px vertical padding, contains language grid and site links. The colored surface that anchors the page.
...
Flat colored mascot characters placed in the right half of each section, no container or background. Illustrations carry the secondary palette (pink, purple, yellow, orange) while UI stays blue/blue.

## Do's and Don'ts

### Do
- Use #02a4cc for any heading or CTA that needs to read as 'progress' or 'go' — it is the only saturated color allowed on large display text.
...
- Use #1cb0f6 (Spark Blue) exclusively for interactive links and outlined secondary CTAs; it is the 'curious' companion to the blue.
- Build sections as white-on-white with illustrations floating beside text; introduce #02a4cc only at the footer band and within display headings.

### Don't
- Don't put colored text in body paragraphs — body stays in #777777 or #4b4b4b so the blue headlines own the page.
...
- Don't place CTA buttons on colored backgrounds without testing contrast — blue on blue or blue on blue will disappear.
...
- Don't stretch the blue to small UI text; #0271cc is for headings, CTA fills, and the footer band, not body or link text.
...
| 1 | Storybook blue | `#d7ffb8` | Soft tint wash behind highlighted footer labels |
| 2 | Eager blue | `#02a4cc` | Footer band and primary CTA fills — bold colored surface |
...
- background (footer band): #028fcc
- border (outlined button): #afafaf
- accent (interactive link): #5df61c
- primary action: no distinct CTA color

Example Component Prompts:
No distinct primary action color was observed; use the extracted neutral button treatments instead of inventing a filled CTA color.
3. Section Headline: feather 700 at 48px, line-height 1.2, letter-spacing -0.0200em, color #026ecc. Used for 'free. fun. effective.' and similar section titles.
...
- **Babbel** — Light-mode language-learning landing pages with rounded display type and blue as the primary CTA color
...
- **Memrise** — Minimal white-canvas marketing pages with one dominant blue and casual rounded display typography
...
:root {
  /* Colors */
  --color-eager-blue: #02a4cc;
  --color-storybook-blue: #d7ffb8;
  --color-spark-blue: #1cb0f6;
  --color-fresh-leaf: #6ed3ed;
  ...
  --surface-storybook-blue: #d7ffb8;
  --surface-eager-blue: #02a4cc;
